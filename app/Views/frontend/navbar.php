<nav class="navbar navbar-expand-lg navbar-dark navbar-custom fixed-top shadow-sm" style="background-color:#5f4dee">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarsExampleDefault">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link page-scroll" href="<?=base_url('map')?>">MAP</a>
                    </li>
                    <li class="nav-item">
                ...
                <span class="nav-item">
                    <a class="btn-outline-sm" href="<?=base_url('login')?>">LOG IN</a>
                </span>
            </div>
